...
@implementation ORCGIGURLParametersFormatter
...
- (NSData *)multipartBodyWithParameters:(NSDictionary *)parameters files:(NSArray *)files boundary:(NSString *)boundary
{
    ...
    [files enumerateObjectsUsingBlock:^(ORCGIGURLFile *file, NSUInteger idx, BOOL __unused *stop) {
...
- (NSData *)dataForFile:(ORCGIGURLFile *)file boundary:(NSString *)boundary
{
...
- (NSData *)contentDispositionForFile:(ORCGIGURLFile *)file
{
...
- (NSData *)contentTypeForFile:(ORCGIGURLFile *)file
{
