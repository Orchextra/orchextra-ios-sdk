...
@property (strong, nonatomic) ORCGIGURLFormatter *urlFormatter;

@end


@implementation ORCGIGURLConfigAddDomainViewController
...
- (void)viewDidLoad
{
    ...
    self.urlFormatter = [[ORCGIGURLFormatter alloc] init];
...
- (void)saveDomainAndDismiss
{
    ...
    ORCGIGURLDomain *newDomain = [[ORCGIGURLDomain alloc] initWithName:name url:url];
