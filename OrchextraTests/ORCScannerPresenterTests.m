...
- (void)setUp
{
    ...
    self.presenter = [[ORCScannerPresenter alloc] initWithViewController:self.scannerViewControllerMock
                                                         actionInterface:self.actionInterface interactor:self.interactorMock];
}
