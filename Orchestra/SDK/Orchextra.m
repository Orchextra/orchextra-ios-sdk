...
- (instancetype)init
{
    ...
    ORCActionManager *actionManager = [[ORCActionManager alloc] init];
...
- (void)startScanner
{
    ORCAction *barcodeAction = [[ORCAction alloc] initWithType:ORCTypeScan];
...
{
    ORCAction *vuforiaAction = [[ORCAction alloc] initWithType:ORCTypeVuforia];
    vuforiaAction.urlString = ORCSchemeVuforia;
    
    [self.actionManager launchAction:vuforiaAction];
}
