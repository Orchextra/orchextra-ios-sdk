...
@implementation ORCGIGURLFixture
...
+ (NSArray *)fixturesWithJSON:(NSArray *)fixturesJSON bundle:(NSBundle *)bundle
{
    ...
    {
        ORCGIGURLFixture *fixture = [[ORCGIGURLFixture alloc] initWithJSON:fixtureJSON bundle:bundle];
...
- (BOOL)isEqualToFixture:(ORCGIGURLFixture *)fixture
{
