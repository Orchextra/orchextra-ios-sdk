...
@implementation VuforiaApplicationShaderUtils
...
+ (GLuint)compileShader:(NSString*)shaderFileName withDefs:(NSString *) defs withType:(GLenum)shaderType {
    ...
    // 1
    NSString* shaderPath = [[NSBundle bundleSDK] pathForResource:shaderName ofType:shaderFileType];
    NSError* error;
...
+ (int)createProgramWithVertexShaderFileName:(NSString*) vertexShaderFileName
    ...
    return [VuforiaApplicationShaderUtils createProgramWithVertexShaderFileName:vertexShaderFileName
